...
from evals.action_anticipation_frozen.ego4d_keystep import filter_annotations as ego4d_filter_annotations
from evals.action_anticipation_frozen.ego4d_keystep import make_webvid as ego4d_make_webvid
...
def init_data(
    ...
    if make_webvid is None and ("ego4d" in dataset.lower() or "keystep" in dataset.lower()):
        make_webvid = ego4d_make_webvid
...
def filter_annotations(
    ...
    **kwargs,
    ...
    if _filter is None and ("ego4d" in dataset.lower() or "keystep" in dataset.lower()):
        _filter = ego4d_filter_annotations
